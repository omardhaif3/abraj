      ...
      <nav className="font-cairo top-0 bg-transparent z-50">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-between relative">
            <div className={`flex items-center ${isRTL ? "justify-end pl-10" : "justify-start pl-0"} w-64 md:w-64 w-full md:pl-0  `}>
              <a href="/" className={`flex items-center ${isRTL ? "flex-row-reverse" : ""}`} onClick={handleHomeClick}>
                ...
                <div className="text-white leading-tight">
                  <div className="text-sm items-start md:text-lg font-semibold p-0 m-0">شركة أبراج الوطنيـة</div>
